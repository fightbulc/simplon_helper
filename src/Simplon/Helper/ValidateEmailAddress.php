<?php
    ...
    class ValidateEmailAddress
    {
        ...
        {
            return !ValidateEmailAddress::_validateEmailAddress($email) ? FALSE : TRUE;
        }
         ...
         * @return int
         */
        protected static function _validateEmailAddress($email, $options = [])
        {
            #
            ...
            {
                $email = ValidateEmailAddress::_emailStripComments($outer_comment, $email, "(x)");
            }
            ...
            if ($options['allow_comments'])
            {
                $bits['local'] = ValidateEmailAddress::_emailStripComments($comment, $bits['local']);
                $bits['domain'] = ValidateEmailAddress::_emailStripComments($comment, $bits['domain']);
            }
         ...
         * @return mixed
         */
        protected static function _emailStripComments($comment, $email, $replace = '')
        {
            while (1)
            {
